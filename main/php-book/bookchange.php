        ...
        <div class="content-group"style="background-color: #fff;" >
            ...
            <div class="content content1" style="height:500px;" >
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <p>&emsp;&emsp;&emsp;&emsp;作者：<input class="inputt" name="author" id="author"type="text"></p><p>&emsp;&emsp;&ensp;&ensp;&ensp;&ensp;數量：<input class="inputt" name="num" type='number' min='0'value='1' onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')"></p>
